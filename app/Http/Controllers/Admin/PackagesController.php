...
class PackagesController extends Controller
{
    ...
    public function index(IndexPackage $request)
    {
        ...
        $data = AdminListing::create(Package::class)->processRequestAndGet(
            ...
            ['id', 'name', 'long', 'limited', 'shipment_count', 'price', 'weight_default', 'weight_fee', 'road', 'road_sale', 'pickup', 'pickup_fee', 'todoor', 'todoor_fee', 'express', 'express_fee', 'breakable', 'breakable_fee', 'is_published', 'for_stuff'],
