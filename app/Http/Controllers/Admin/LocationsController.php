...
class LocationsController extends Controller
{
    ...
    public function index(IndexLocation $request)
    {
        ...
        $data = AdminListing::create(Location::class)->processRequestAndGet(
            ...
            ['id', 'state', 'city', 'street', 'location', 'lng', 'lat', 'for_type', 'for_id'],

            // set columns to searchIn
            ['id', 'state', 'city', 'street', 'location', 'for_type']
        );
    ...
    {
        return Excel::download(app(LocationsExport::class), 'locations.xlsx');
    }
}
