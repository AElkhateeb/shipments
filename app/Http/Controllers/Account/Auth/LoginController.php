...
class LoginController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectToAfterLogout = '/account/login';
    ...
    public function __construct()
    {
        ...
        $this->redirectTo = config('account-auth.login_redirect');
        $this->redirectToAfterLogout = config('account-auth.logout_redirect');
       $this->middleware('guest.admin:' . $this->guard)->except('logout');
       // $this->middleware('guest.account:' . $this->guard)->except('logout');
    }
    ...
    {
        $conditions = [];
        if (config('account-auth.check_forbidden')) {
            $conditions['forbidden'] = false;
        }
        if (config('account-auth.activation_enabled')) {
