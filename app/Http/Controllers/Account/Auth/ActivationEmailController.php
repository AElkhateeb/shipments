...
class ActivationEmailController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $activationBroker = 'account_admins';
    ...
    public function __construct()
    {
        ...
        $this->activationBroker = config('account-auth.defaults.activations');
    ...
    {
        if (config('account-auth.self_activation_form_enabled')) {
            return view('account.auth.activation.email');
        } else {
            abort(404);
        }
    }
