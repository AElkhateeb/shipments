...
class ResetPasswordController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $passwordBroker = 'account_admins';
    ...
    public function __construct()
    {
        ...
        $this->passwordBroker = config('account-auth.defaults.passwords');
        $this->redirectTo = config('account-auth.password_reset_redirect');
