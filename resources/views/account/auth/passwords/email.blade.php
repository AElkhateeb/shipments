			...
			<div class="col-md-6 col-lg-5">
				<div class="card">
					<div class="card-block">
							<auth-form
									:action="'{{ url('/account/password-reset/send') }}'"
									:data="{ 'email': '{{ old('email', '') }}' }"
									inline-template>
								<form class="form-horizontal" role="form" method="POST" action="{{ url('/account/password-reset/send') }}" novalidate>
									{{ csrf_field() }}
									...
									<div class="auth-body">
										@include('account.auth.includes.messages')
