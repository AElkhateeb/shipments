...
class FillCeoPermissionsForSiteOption extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'ceo.site-option',
            'ceo.site-option.index',
            'ceo.site-option.create',
            'ceo.site-option.show',
            'ceo.site-option.edit',
            'ceo.site-option.delete',
            'ceo.site-option.bulk-delete',
        ]);
