...
class FillSeoAdminAndAdminPermissions extends Migration
{
    /**
    ...
    {
        $this->guardName = config('seo-auth.defaults.guard');
        ...
        $defaultPermissions = collect([
            ...
            // manage translations
            'seo.translation.index',
            'seo.translation.edit',
            'seo.translation.rescan',

            // manage users (access)

            'seo.seo-admin.index',
            'seo.seo-admin.create',
            'seo.seo-admin.edit',
            'seo.seo-admin.delete',
            'seo.seo-admin.impersonal-login',
        ...
        $this->roles = [
            [
                ...
                'permissions' => $defaultPermissions->reject(function ($permission) {
                    return $permission === 'seo.seo-admin.impersonal-login';
                }),
            ],
        ];
        ...
        DB::transaction(function () {
            ...
            foreach ($this->users as $user) {
                ...
                if ($userItem === null) {
                    ...
                    SeoAdmin::find($userId)->addMedia(storage_path() . '/images/avatar.png')
                        ->preservingOriginal()
    ...
    public function down(): void
    {
        ...
        DB::transaction(function () {
            foreach ($this->users as $user) {
                ...
                if ($userItem !== null) {
                    SeoAdmin::find($userItem->id)->media()->delete();
