...
class FillMangerPermissionsForMovement extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'manger.movement',
            'manger.movement.index',
            'manger.movement.create',
            'manger.movement.show',
            'manger.movement.edit',
            'manger.movement.delete',
            'manger.movement.bulk-delete',
        ]);
