...
class FillMangerPermissionsForWithdrawal extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'manger.withdrawal',
            'manger.withdrawal.index',
            'manger.withdrawal.create',
            'manger.withdrawal.show',
            'manger.withdrawal.edit',
            'manger.withdrawal.delete',
            'manger.withdrawal.bulk-delete',
        ]);
