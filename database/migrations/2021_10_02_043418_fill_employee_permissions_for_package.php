...
class FillEmployeePermissionsForPackage extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.package',
            'employee.package.index',
            'employee.package.create',
            'employee.package.show',
            'employee.package.edit',
            'employee.package.delete',
            'employee.package.bulk-delete',
        ]);
