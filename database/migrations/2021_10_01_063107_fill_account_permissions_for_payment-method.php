...
class FillAccountPermissionsForPaymentMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'account.payment-method.create',
            'account.payment-method.show',
            'account.payment-method.edit',
            'account.payment-method.delete',
            'account.payment-method.bulk-delete',
        ]);
