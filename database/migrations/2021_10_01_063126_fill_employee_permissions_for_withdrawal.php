...
class FillEmployeePermissionsForWithdrawal extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.withdrawal',
            'employee.withdrawal.index',
            'employee.withdrawal.create',
            'employee.withdrawal.show',
            'employee.withdrawal.edit',
            'employee.withdrawal.delete',
            'employee.withdrawal.bulk-delete',
        ]);
