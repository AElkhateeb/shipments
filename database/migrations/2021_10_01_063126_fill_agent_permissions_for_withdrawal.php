...
class FillAgentPermissionsForWithdrawal extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'agent.withdrawal',
            'agent.withdrawal.index',
            'agent.withdrawal.create',
            'agent.withdrawal.show',
            'agent.withdrawal.edit',
            'agent.withdrawal.delete',
            'agent.withdrawal.bulk-delete',
        ]);
