...
class FillEmployeeAdminAndAdminPermissions extends Migration
{
    /**
    ...
    {
        $this->guardName = config('employee-auth.defaults.guard');
        ...
        $defaultPermissions = collect([
            ...
            // manage translations
            'employee.translation.index',
            'employee.translation.edit',
            'employee.translation.rescan',

            // manage users (access)


            'employee.shipper-admin.index',
            'employee.shipper-admin.create',
            'employee.shipper-admin.edit',
            'employee.shipper-admin.delete',
            'employee.shipper-admin.impersonal-login',

            'employee.account-admin.index',
            'employee.account-admin.create',
            'employee.account-admin.edit',
            'employee.account-admin.delete',
            'employee.account-admin.impersonal-login',
        ...
        $this->roles = [
            [
                ...
                'permissions' => $defaultPermissions->reject(function ($permission) {
                    return $permission === 'employee.employee-admin.impersonal-login';
                }),
            ],
        ];
        ...
        DB::transaction(function () {
            ...
            foreach ($this->users as $user) {
                ...
                if ($userItem === null) {
                    ...
                    EmployeeAdmin::find($userId)->addMedia(storage_path() . '/images/avatar.png')
                        ->preservingOriginal()
    ...
    public function down(): void
    {
        ...
        DB::transaction(function () {
            foreach ($this->users as $user) {
                ...
                if ($userItem !== null) {
                    EmployeeAdmin::find($userItem->id)->media()->delete();
