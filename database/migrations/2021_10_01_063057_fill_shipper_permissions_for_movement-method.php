...
class FillShipperPermissionsForMovementMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'shipper.movement-method',
            'shipper.movement-method.index',
            'shipper.movement-method.create',
            'shipper.movement-method.show',
            'shipper.movement-method.edit',
            'shipper.movement-method.delete',
            'shipper.movement-method.bulk-delete',
        ]);
