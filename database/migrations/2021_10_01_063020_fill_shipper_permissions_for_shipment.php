...
class FillShipperPermissionsForShipment extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'shipper.shipment',
            'shipper.shipment.index',
            'shipper.shipment.create',
            'shipper.shipment.show',
            'shipper.shipment.edit',
            'shipper.shipment.delete',
            'shipper.shipment.bulk-delete',
        ]);
