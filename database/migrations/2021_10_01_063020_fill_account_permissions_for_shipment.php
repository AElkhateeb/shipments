...
class FillAccountPermissionsForShipment extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'account.shipment',
            'account.shipment.index',
            'account.shipment.create',
            'account.shipment.show',
            'account.shipment.edit',
            'account.shipment.delete',
            'account.shipment.bulk-delete',
        ]);
