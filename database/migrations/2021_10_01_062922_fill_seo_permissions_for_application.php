...
class FillSeoPermissionsForApplication extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'seo.application',
            'seo.application.index',
            'seo.application.create',
            'seo.application.show',
            'seo.application.edit',
            'seo.application.delete',
            'seo.application.bulk-delete',
        ]);
