...
class FillCeoPermissionsForTestimonial extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'ceo.testimonial',
            'ceo.testimonial.index',
            'ceo.testimonial.create',
            'ceo.testimonial.show',
            'ceo.testimonial.edit',
            'ceo.testimonial.delete',
            'ceo.testimonial.bulk-delete',
        ]);
