...
class FillShipperPermissionsForPaymentMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'shipper.payment-method.index',
            'shipper.payment-method.create',
            'shipper.payment-method.show',
            'shipper.payment-method.edit',
            'shipper.payment-method.delete',
            'shipper.payment-method.bulk-delete',
        ]);
