...
class FillShipperPermissionsForMovement extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'shipper.movement',
            'shipper.movement.index',
            'shipper.movement.create',
            'shipper.movement.show',
            'shipper.movement.edit',
            'shipper.movement.delete',
            'shipper.movement.bulk-delete',
        ]);
