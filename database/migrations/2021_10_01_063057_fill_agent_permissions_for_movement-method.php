...
class FillAgentPermissionsForMovementMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'agent.movement-method.index',
            'agent.movement-method.create',
            'agent.movement-method.show',
            'agent.movement-method.edit',
            'agent.movement-method.delete',
            'agent.movement-method.bulk-delete',
        ]);
