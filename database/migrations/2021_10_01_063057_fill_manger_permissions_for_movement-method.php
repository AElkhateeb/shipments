...
class FillMangerPermissionsForMovementMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'manger.movement-method',
            'manger.movement-method.index',
            'manger.movement-method.create',
            'manger.movement-method.show',
            'manger.movement-method.edit',
            'manger.movement-method.delete',
            'manger.movement-method.bulk-delete',
        ]);
