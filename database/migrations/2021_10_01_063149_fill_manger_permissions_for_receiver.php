...
class FillMangerPermissionsForReceiver extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'manger.receiver',
            'manger.receiver.index',
            'manger.receiver.create',
            'manger.receiver.show',
            'manger.receiver.edit',
            'manger.receiver.delete',
            'manger.receiver.bulk-delete',
        ]);
