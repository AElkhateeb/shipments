...
class FillEmployeePermissionsForBranch extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBranch constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'employee.branch.show',
            'employee.branch.edit',
            'employee.branch.delete',
            'employee.branch.bulk-delete',
        ]);
