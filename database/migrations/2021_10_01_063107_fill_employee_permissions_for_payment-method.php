...
class FillEmployeePermissionsForPaymentMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'employee.payment-method.index',
            'employee.payment-method.create',
            'employee.payment-method.show',
            'employee.payment-method.edit',
            'employee.payment-method.delete',
            'employee.payment-method.bulk-delete',
        ]);
