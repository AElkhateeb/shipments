...
class FillEmployeePermissionsForWallet extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.wallet',
            'employee.wallet.index',
            'employee.wallet.create',
            'employee.wallet.show',
            'employee.wallet.edit',
            'employee.wallet.delete',
            'employee.wallet.bulk-delete',
        ]);
