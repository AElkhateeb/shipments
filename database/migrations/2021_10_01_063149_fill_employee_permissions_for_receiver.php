...
class FillEmployeePermissionsForReceiver extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.receiver',
            'employee.receiver.index',
            'employee.receiver.create',
            'employee.receiver.show',
            'employee.receiver.edit',
            'employee.receiver.delete',
            'employee.receiver.bulk-delete',
        ]);
