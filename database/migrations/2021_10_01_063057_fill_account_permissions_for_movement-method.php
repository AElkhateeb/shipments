...
class FillAccountPermissionsForMovementMethod extends Migration
{
    /**
    ...
    {
        $this->guardName = config('account-auth.defaults.guard');

        $permissions = collect([
            'account.movement-method',
            'account.movement-method.index',
            'account.movement-method.create',
            'account.movement-method.show',
            'account.movement-method.edit',
            'account.movement-method.delete',
            'account.movement-method.bulk-delete',
        ]);
