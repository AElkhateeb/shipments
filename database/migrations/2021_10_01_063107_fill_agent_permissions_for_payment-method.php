...
class FillAgentPermissionsForPaymentMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'agent.payment-method.index',
            'agent.payment-method.create',
            'agent.payment-method.show',
            'agent.payment-method.edit',
            'agent.payment-method.delete',
            'agent.payment-method.bulk-delete',
        ]);
