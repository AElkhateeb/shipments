...
class FillMangerPermissionsForPaymentMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'manger.payment-method',
            'manger.payment-method.index',
            'manger.payment-method.create',
            'manger.payment-method.show',
            'manger.payment-method.edit',
            'manger.payment-method.delete',
            'manger.payment-method.bulk-delete',
        ]);
