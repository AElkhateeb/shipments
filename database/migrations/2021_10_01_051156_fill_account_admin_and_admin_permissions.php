...
class FillAccountAdminAndAdminPermissions extends Migration
{
    /**
        ...
        $this->roles = [
            [
                ...
                'permissions' => $defaultPermissions->reject(function ($permission) {
                    return $permission === 'account.account-admin.impersonal-login';
                }),
            ],
        ];
        ...
        DB::transaction(function () {
            ...
            foreach ($this->users as $user) {
                ...
                if ($userItem === null) {
                    ...
                    AccountAdmin::find($userId)->addMedia(storage_path() . '/images/avatar.png')
                        ->preservingOriginal()
    ...
    public function down(): void
    {
        ...
        DB::transaction(function () {
            foreach ($this->users as $user) {
                ...
                if ($userItem !== null) {
                    AccountAdmin::find($userItem->id)->media()->delete();
