...
class FillPermissionsForShipmentItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForShipmentItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.shipment-item',
            'admin.shipment-item.index',
            'admin.shipment-item.create',
            'admin.shipment-item.show',
            'admin.shipment-item.edit',
            'admin.shipment-item.delete',
            'admin.shipment-item.bulk-delete',
        ]);
