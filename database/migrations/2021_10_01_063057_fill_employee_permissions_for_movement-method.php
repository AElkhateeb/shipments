...
class FillEmployeePermissionsForMovementMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.movement-method',
            'employee.movement-method.index',
            'employee.movement-method.create',
            'employee.movement-method.show',
            'employee.movement-method.edit',
            'employee.movement-method.delete',
            'employee.movement-method.bulk-delete',
        ]);
