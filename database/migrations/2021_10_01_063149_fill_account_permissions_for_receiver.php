...
class FillAccountPermissionsForReceiver extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'account.receiver',
            'account.receiver.index',
            'account.receiver.create',
            'account.receiver.show',
            'account.receiver.edit',
            'account.receiver.delete',
            'account.receiver.bulk-delete',
        ]);
