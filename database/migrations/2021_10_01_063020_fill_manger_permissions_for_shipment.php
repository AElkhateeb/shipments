...
class FillMangerPermissionsForShipment extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'manger.shipment',
            'manger.shipment.index',
            'manger.shipment.create',
            'manger.shipment.show',
            'manger.shipment.edit',
            'manger.shipment.delete',
            'manger.shipment.bulk-delete',
        ]);
