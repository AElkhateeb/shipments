...
class FillEmployeePermissionsForShipment extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.shipment',
            'employee.shipment.index',
            'employee.shipment.create',
            'employee.shipment.show',
            'employee.shipment.edit',
            'employee.shipment.delete',
            'employee.shipment.bulk-delete',
        ]);
