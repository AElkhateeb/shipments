...
class FillDefaultAdminUserAndPermissions extends Migration
{
    ...
    public function __construct()
    {
        ...
        $defaultPermissions = collect([
            ...
            'admin.ceo-admin.index',
            'admin.ceo-admin.create',
            'admin.ceo-admin.edit',
            'admin.ceo-admin.delete',
            'admin.ceo-admin.impersonal-login',

            'admin.agent-admin.index',
            'admin.agent-admin.create',
            'admin.agent-admin.edit',
            'admin.agent-admin.delete',
            'admin.agent-admin.impersonal-login',

            'admin.manger-admin.index',
            'admin.manger-admin.create',
            'admin.manger-admin.edit',
            'admin.manger-admin.delete',
            'admin.manger-admin.impersonal-login',

            'admin.employee-admin.index',
            'admin.employee-admin.create',
            'admin.employee-admin.edit',
            'admin.employee-admin.delete',
            'admin.employee-admin.impersonal-login',

            'admin.seo-admin.index',
            'admin.seo-admin.create',
            'admin.seo-admin.edit',
            'admin.seo-admin.delete',
            'admin.seo-admin.impersonal-login',

            'admin.shipper-admin.index',
            'admin.shipper-admin.create',
            'admin.shipper-admin.edit',
            'admin.shipper-admin.delete',
            'admin.shipper-admin.impersonal-login',

            'admin.account-admin.index',
            'admin.account-admin.create',
            'admin.account-admin.edit',
            'admin.account-admin.delete',
            'admin.account-admin.impersonal-login',
