...
class FillCeoPermissionsForMovementMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'ceo.movement-method',
            'ceo.movement-method.index',
            'ceo.movement-method.create',
            'ceo.movement-method.show',
            'ceo.movement-method.edit',
            'ceo.movement-method.delete',
            'ceo.movement-method.bulk-delete',
        ]);
