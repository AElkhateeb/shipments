...
class FillShipperPermissionsForWithdrawal extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'shipper.withdrawal',
            'shipper.withdrawal.index',
            'shipper.withdrawal.create',
            'shipper.withdrawal.show',
            'shipper.withdrawal.edit',
            'shipper.withdrawal.delete',
            'shipper.withdrawal.bulk-delete',
        ]);
