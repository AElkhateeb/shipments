...
class FillCeoPermissionsForPaymentMethod extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'ceo.payment-method',
            'ceo.payment-method.index',
            'ceo.payment-method.create',
            'ceo.payment-method.show',
            'ceo.payment-method.edit',
            'ceo.payment-method.delete',
            'ceo.payment-method.bulk-delete',
        ]);
