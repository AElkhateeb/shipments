...
class FillShipperPermissionsForPackage extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'shipper.package',
            'shipper.package.index',
            'shipper.package.create',
            'shipper.package.show',
            'shipper.package.edit',
            'shipper.package.delete',
            'shipper.package.bulk-delete',
        ]);
