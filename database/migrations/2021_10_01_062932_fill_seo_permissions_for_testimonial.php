...
class FillSeoPermissionsForTestimonial extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'seo.testimonial',
            'seo.testimonial.index',
            'seo.testimonial.create',
            'seo.testimonial.show',
            'seo.testimonial.edit',
            'seo.testimonial.delete',
            'seo.testimonial.bulk-delete',
        ]);
