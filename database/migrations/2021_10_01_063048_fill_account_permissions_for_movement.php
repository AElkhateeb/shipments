...
class FillAccountPermissionsForMovement extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'account.movement',
            'account.movement.index',
            'account.movement.create',
            'account.movement.show',
            'account.movement.edit',
            'account.movement.delete',
            'account.movement.bulk-delete',
        ]);
