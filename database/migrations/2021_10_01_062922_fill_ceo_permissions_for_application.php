...
class FillCeoPermissionsForApplication extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'ceo.application',
            'ceo.application.index',
            'ceo.application.create',
            'ceo.application.show',
            'ceo.application.edit',
            'ceo.application.delete',
            'ceo.application.bulk-delete',
        ]);
