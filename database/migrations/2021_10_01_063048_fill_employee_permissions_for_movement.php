...
class FillEmployeePermissionsForMovement extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'employee.movement',
            'employee.movement.index',
            'employee.movement.create',
            'employee.movement.show',
            'employee.movement.edit',
            'employee.movement.delete',
            'employee.movement.bulk-delete',
        ]);
