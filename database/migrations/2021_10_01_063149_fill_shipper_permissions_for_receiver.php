...
class FillShipperPermissionsForReceiver extends Migration
{
    /**
    ...
    public function __construct()
    {
        ...
        $permissions = collect([
            'shipper.receiver',
            'shipper.receiver.index',
            'shipper.receiver.create',
            'shipper.receiver.show',
            'shipper.receiver.edit',
            'shipper.receiver.delete',
            'shipper.receiver.bulk-delete',
        ]);
